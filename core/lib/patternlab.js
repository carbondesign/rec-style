...
var patternlab_engine = function (config) {
  ...
  function buildPatterns(deletePatternDir) {
    ...
    try {
      patternlab.userHead = pattern_assembler.get_pattern_by_key('basic-head', patternlab);
    }
    catch (ex) {
      if (patternlab.config.debug) {
        console.log(ex);
        console.log('Could not find optional user-defined header, basic-head  pattern. It was likely deleted.');
      }
    }
    try {
      patternlab.userFoot = pattern_assembler.get_pattern_by_key('basic-foot', patternlab);
    }
    catch (ex) {
      if (patternlab.config.debug) {
        console.log(ex);
        console.log('Could not find optional user-defined footer, basic-foot pattern. It was likely deleted.');
      }
    }
