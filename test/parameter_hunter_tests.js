(function () {
  ...
  function currentPatternClosure() {
    return {
      ...
      "name": "02-applications-02-comments-01-sticky-comment",
      "patternName": "sticky-comment",
      "patternLink": "02-applications-02-comments-01-sticky-comment/02-applications-02-comments-01-sticky-comment.html",
      "patternGroup": "organisms",
      "patternSubGroup": "comments",
      "flatPatternPath": "02-applications-02-comments",
      "key": "applications-sticky-comment",
      "template": "{{> components-single-comment(description: 'A life is like a garden. Perfect moments can be had, but not preserved, except in memory.') }}",
      "extendedTemplate": "{{> components-single-comment(description: 'A life is like a garden. Perfect moments can be had, but not preserved, except in memory.') }}",
      "parameteredPartials": [
        "{{> components-single-comment(description: 'We are all in the gutter, but some of us are looking at the stars.') }}",
        "{{> components-single-comment(description: 'A life is like a garden. Perfect moments can be had, but not preserved, except in memory.') }}"
      ]
    };
  }
      ...
      patterns: [
        {
          ...
          "name": "01-components-06-components-02-single-comment",
          "patternName": "single-comment",
          "patternLink": "01-components-06-components-02-single-comment/01-components-06-components-02-single-comment.html",
          "patternGroup": "molecules",
          "patternSubGroup": "components",
          "flatPatternPath": "01-components-06-components",
          "key": "components-single-comment",
  ...
  exports['parameter_hunter'] = {
    ...
    'parameter hunter parses parameters with unquoted keys and unquoted values' : function(test){
      ...
      currentPattern.template = "{{> components-single-comment(description: true) }}";
      currentPattern.extendedTemplate = currentPattern.template;
    ...
    'parameter hunter parses parameters with single-quoted keys and single-quoted values wrapping internal escaped single-quotes' : function(test){
      ...
      currentPattern.template = "{{> components-single-comment('description': 'true not,\\'true\\'') }}";
      currentPattern.extendedTemplate = currentPattern.template;
      currentPattern.parameteredPartials[0] = currentPattern.template;
    ...
    'parameter hunter parses parameters with combination of quoting schemes for keys and values' : function(test){
      ...
      currentPattern.template = "{{> components-single-comment(description: true, 'foo': false, \"bar\": false, 'single': true, 'singlesingle': 'true', 'singledouble': \"true\", \"double\": true, \"doublesingle\": 'true', \"doubledouble\": \"true\") }}";
      currentPattern.extendedTemplate = currentPattern.template;
      currentPattern.parameteredPartials[0] = currentPattern.template;
    ...
    'parameter hunter parses parameters with values containing a closing parenthesis' : function(test){
      ...
      currentPattern.template = "{{> components-single-comment(description: 'Hello ) World') }}";
      currentPattern.extendedTemplate = currentPattern.template;
      currentPattern.parameteredPartials[0] = currentPattern.template;
    ...
    'parameter hunter parses parameters that follow a non-quoted value' : function(test){
      ...
      currentPattern.template = "{{> components-single-comment(foo: true, bar: \"Hello World\") }}";
      currentPattern.extendedTemplate = currentPattern.template;
      currentPattern.parameteredPartials[0] = currentPattern.template;
    ...
    'parameter hunter parses parameters whose keys contain escaped quotes' : function(test){
      ...
      currentPattern.template = "{{> components-single-comment('silly\\\'key': true, bar: \"Hello World\", \"another\\\"silly-key\": 42 ) }}";
      currentPattern.extendedTemplate = currentPattern.template;
      currentPattern.parameteredPartials[0] = currentPattern.template;
    ...
    'parameter hunter skips malformed parameters' : function(test){
      ...
      currentPattern.template = "{{> components-single-comment( missing-val: , : missing-key, : , , foo: \"Hello World\") }}";
      currentPattern.extendedTemplate = currentPattern.template;
      currentPattern.parameteredPartials[0] = currentPattern.template;
    ...
    'parameter hunter parses parameters containing html tags' : function(test){
      ...
      currentPattern.template = "{{> components-single-comment(tag1: '<strong>Single-quoted</strong>', tag2: \"<em>Double-quoted</em>\", tag3: '<strong class=\\\"foo\\\" id=\\\'bar\\\'>With attributes</strong>') }}";
      currentPattern.extendedTemplate = currentPattern.template;
      currentPattern.parameteredPartials[0] = currentPattern.template;
