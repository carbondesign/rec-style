...
"use strict";
	...
	exports['oPattern initialization'] = {
		'test oPattern initializes correctly' : function(test){
			...
			test.equals(p.name, '00-basic-00-global-00-colors');
			...
			test.equals(p.patternLink, '00-basic-00-global-00-colors/00-basic-00-global-00-colors.html');
			test.equals(p.patternGroup, 'atoms');
			test.equals(p.patternSubGroup, 'global');
			test.equals(p.flatPatternPath, '00-basic-00-global');
			test.equals(p.key, 'basic-colors');
